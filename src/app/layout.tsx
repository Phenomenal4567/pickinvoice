...
export const metadata: Metadata = {
  ...
  description: 'Create, send, and track professional invoices and receipts in minutes. WhatsApp-native. Mobile-first.',
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <ClerkProvider>
      <html lang="en">
        <body className={`${inter.variable} ${sora.variable} ${dmMono.variable} font-sans antialiased bg-gray-50`}>
          {children}
          <Toaster />
          <Analytics />
        </body>
